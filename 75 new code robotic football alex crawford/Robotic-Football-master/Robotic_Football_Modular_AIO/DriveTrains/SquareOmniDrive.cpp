...
if((leftX == 0) && (rightX == 0)){
  ...
  throttleM1 = (motorDirection * (-1*horizontal - turn) / handicap) + 90;
  throttleM2 = (motorDirection * (vertical - turn)  	/ handicap) + 90;
  throttleM3 = (motorDirection * (horizontal - turn)	/ handicap) + 90;
  throttleM4 = (motorDirection * (-1*vertical - turn)   / handicap) + 90;
